...
if ( ! function_exists( 'lalita_get_default_fonts' ) ) {
	...
	function lalita_get_default_fonts( $filter = true ) {
		$lalita_font_defaults = array(
			...
			'font_blog_header_text' => 'Raleway',
			'font_blog_header_text_category' => '',
			'font_blog_header_text_variants' => '100,200,300,regular,500,600,700,800,900',
			'blog_header_text_font_weight' => '600',
			'blog_header_text_font_transform' => 'none',
			'font_navigation' => 'Raleway',
			...
			'footer_font_size' => '18',
			'font_fixed_side' => 'Raleway',
			'font_fixed_side_category' => '',
			'font_fixed_side_variants' => '100,200,300,regular,500,600,700,800,900',
...
define( 'LALITA_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Raleway:100,200,300,regular,500,600,700,800,900' );
